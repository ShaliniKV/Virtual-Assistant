...
public class TestingLabSelection extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String page="testing_labs.jsp";
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			String sql=null;
			try {
				sql = "select LaboratoryName from chemistreg  where City='"+requestSource+"' order by LaboratoryName asc";
