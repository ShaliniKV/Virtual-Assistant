...
public class AdvisorDetails extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String page="advisor_details.jsp";
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			System.out.println("Do Get Called");
			String requestSource=request.getParameter("advisor");
			...
			String sql=null;
			String location=SpecialitySelection.location(),speciality=AdvisorSelection.speciality();
			try {
				sql = "select * from hpreg  where Name='"+requestSource+"' and City='"+location+"' and Speciality='"+speciality+"'";
