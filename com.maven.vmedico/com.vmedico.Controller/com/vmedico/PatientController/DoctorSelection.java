...
public class DoctorSelection extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String page="doctor_selection.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			String sql=null;
			String location=SpecialitySelection2.location();
			try {
				sql = "select Name from doctorreg  where speciality='"+requestSource+"' and City='"+location+"' order by Name asc";
