...
public class SpecialitySelection2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	String page="speciality2.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			String sql=null;
			try {
				sql = "select Speciality from doctorreg  where City='"+requestSource+"' order by Speciality asc";
