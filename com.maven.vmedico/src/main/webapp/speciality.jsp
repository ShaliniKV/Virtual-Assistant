...
<body> 
<center>
	<form class="form-container" action="AdvisorSelection" method="get">
	<h4><font face="Times New Roman" color="black">Select a speciality from below given list</font></h4>
	<br>
	
	<%Iterator itr;
	 List data= (List)request.getAttribute("data");%>
	 <select class="btn btn-secondary dropdown-toggle" name="speciality">
	<option class="btn btn-secondary dropdown-toggle">Choose speciality</option>
