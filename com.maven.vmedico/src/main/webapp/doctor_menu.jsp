...
<body>
    <center>
        <div class="DoctorMenu">
            <div class="col-md-4 col-sm-4 col-xs-12"></div>
            <div class="col-md-4 col-sm-4 col-xs-12">
                <form class="form-container" action="DoctorMenu" method="post">
                    ...
                    <div class="Tracker">
                        <label for="Tracker">
                            <button type="submit" name="menu" value="tracker" class="btn btn-secondary">Tracker</button>
                        </label>
                    </div>
